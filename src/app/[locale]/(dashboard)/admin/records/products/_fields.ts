...
export function productFields(
  ...
  return [
    ...
    { name: 'groupId', label: t('f.group'), type: 'select', options: groups, hint: t('h.productGroup') },
    { name: 'variationType', label: t('f.variationType'), type: 'text', placeholder: t('f.variationTypeHint'), hint: t('h.variationType') },
