...
export const METRIC_CATALOG: MetricDefinition[] = [
  ...
  { id: 'finance.revenue', source: 'finance', labelEn: 'Sales earned', labelAr: 'إيرادات المبيعات', supportedTypes: ['kpi'], valueKind: 'iqd', defaultType: 'kpi' },
  { id: 'finance.totalSpent', source: 'finance', labelEn: 'Total business spending', labelAr: 'إجمالي إنفاق العمل', supportedTypes: ['kpi'], valueKind: 'iqd', defaultType: 'kpi' },
  ...
  { id: 'finance.grossProfit', source: 'finance', labelEn: 'Gross profit', labelAr: 'مجمل الربح', supportedTypes: ['kpi'], valueKind: 'iqd', defaultType: 'kpi' },
  { id: 'finance.grossMargin', source: 'finance', labelEn: 'Gross margin', labelAr: 'هامش الربح الإجمالي', supportedTypes: ['kpi'], valueKind: 'percent', defaultType: 'kpi' },
  { id: 'finance.contributionProfit', source: 'finance', labelEn: 'Contribution profit', labelAr: 'ربح المساهمة', supportedTypes: ['kpi'], valueKind: 'iqd', defaultType: 'kpi' },
  { id: 'finance.operatingProfit', source: 'finance', labelEn: 'Operating profit', labelAr: 'الربح التشغيلي', supportedTypes: ['kpi'], valueKind: 'iqd', defaultType: 'kpi' },
  { id: 'finance.inventoryPurchases', source: 'finance', labelEn: 'Inventory purchased', labelAr: 'مشتريات المخزون', supportedTypes: ['kpi'], valueKind: 'iqd', defaultType: 'kpi' },
  { id: 'finance.directSellingCosts', source: 'finance', labelEn: 'Delivery & payment fees', labelAr: 'التوصيل ورسوم الدفع', supportedTypes: ['kpi'], valueKind: 'iqd', defaultType: 'kpi' },
...
export const DASHBOARD_TEMPLATES = [
  ...
  },
  {
    ...
    nameAr: 'لوحة المالية',
    descriptionEn: 'Sales earned, total spending, profit layers, cash, and cost classifications.',
    descriptionAr: 'إيرادات المبيعات وإجمالي الإنفاق وطبقات الربح والنقد وتصنيفات التكلفة.',
    config: createDashboardConfig(
      [
        widget('w-revenue', 'kpi', 'Sales earned', 'finance.revenue'),
        widget('w-total-spent', 'kpi', 'Total business spending', 'finance.totalSpent'),
        widget('w-operating-profit', 'kpi', 'Operating profit', 'finance.operatingProfit'),
        widget('w-cash', 'kpi', 'Cash available', 'finance.cash'),
        widget('w-gross-profit', 'kpi', 'Gross profit', 'finance.grossProfit'),
        widget('w-contribution', 'kpi', 'Contribution profit', 'finance.contributionProfit'),
      ...
      [
        ...
        { i: 'w-total-spent', x: 3, y: 0, w: 3, h: 2 },
        { i: 'w-operating-profit', x: 6, y: 0, w: 3, h: 2 },
        { i: 'w-cash', x: 9, y: 0, w: 3, h: 2 },
        { i: 'w-gross-profit', x: 0, y: 2, w: 3, h: 2 },
        { i: 'w-contribution', x: 3, y: 2, w: 3, h: 2 },
        { i: 'w-capex', x: 6, y: 2, w: 2, h: 2 },
        { i: 'w-opex', x: 8, y: 2, w: 2, h: 2 },
        { i: 'w-cogs', x: 10, y: 2, w: 2, h: 2 },
