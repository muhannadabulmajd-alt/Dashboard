...
const TOOL_CAPABILITIES: Record<string, AiCapability> = {
  ...
  prepare_receive_stock: 'OPERATIONS_PAYMENTS',
  prepare_pack_finished_goods: 'OPERATIONS_PAYMENTS',
  prepare_dispatch_stock_transfer: 'OPERATIONS_PAYMENTS',
  prepare_receive_stock_transfer: 'OPERATIONS_PAYMENTS',
  prepare_record_local_expense: 'SPENDING_PURCHASES',
  prepare_return_to_quarantine: 'OPERATIONS_PAYMENTS',
  prepare_dispose_returned_goods: 'OPERATIONS_PAYMENTS',
  prepare_reverse_stock_document: 'OPERATIONS_PAYMENTS',
...
const ACTION_CAPABILITIES: Record<AiPendingActionType, readonly AiCapability[]> = {
  ...
  RECEIVE_STOCK: ['OPERATIONS_PAYMENTS'],
  PACK_FINISHED_GOODS: ['OPERATIONS_PAYMENTS'],
  DISPATCH_STOCK_TRANSFER: ['OPERATIONS_PAYMENTS'],
  RECEIVE_STOCK_TRANSFER: ['OPERATIONS_PAYMENTS'],
  RECORD_LOCAL_EXPENSE: ['SPENDING_PURCHASES'],
  RETURN_TO_QUARANTINE: ['OPERATIONS_PAYMENTS'],
  DISPOSE_RETURNED_GOODS: ['OPERATIONS_PAYMENTS'],
  REVERSE_STOCK_DOCUMENT: ['OPERATIONS_PAYMENTS'],
